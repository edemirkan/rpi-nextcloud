...
**rpi-nextcloud** is an all-in-one lightwight NextCloud docker deployment using nginx, fpm, postgres, docker-gen and acme-companion.
Primarily developed and tested for raspberrypi, but it should work for other architectures, too.
...
## Step 2
Run **./scripts/fresh-start.sh** to start deployment.